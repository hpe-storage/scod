...
```text
wget https://raw.githubusercontent.com/hpe-storage/co-deployments/master/yaml/csi-info-metrics/v1.0.5/hpe-csi-info-metrics.yaml
```

Optional `ServiceMonitor` definition:

```text
wget https://raw.githubusercontent.com/hpe-storage/co-deployments/master/yaml/csi-info-metrics/v1.0.5/hpe-csi-info-metrics-service-monitor.yaml
```
