...
Check that the [HPE CSI Driver](https://scod.hpedev.io/csi_driver/index.html#compatibility_and_support) and [Commvault software](https://documentation.commvault.com/v11/software/system_requirements_for_kubernetes.html) versions are compatible with the Kubernetes version being used.

##### Permissions

This guide assumes you have administrative access to Commvault Command Center and administrator access to a Kubernetes cluster with `kubectl`. Refer to the [Creating a Service Account for Kubernetes Authentication](https://documentation.commvault.com/v11/software/creating_kubernetes_service_account_and_clusterrolebinding.html) documentation to define a `serviceaccount` and `clusterrolebinding` with `cluster-admin` permissions.
...
To configure data protection for Kubernetes, follow the [official Commvault documentation](https://documentation.commvault.com/v11/software/protecting_kubernetes_with_commvault.html) and ensure the version matches the software version in your environment.
As a summary, complete the following:

- [Core Setup Wizard](https://documentation.commvault.com/v11/software/completing_core_setup.html) to complete Commvault deployment
- Review [System Requirements for Kubernetes](https://documentation.commvault.com/v11/software/system_requirements_for_kubernetes.html)
- Complete the [Kubernetes Guided Setup](https://documentation.commvault.com/v11/software/completing_guided_setup_for_kubernetes.html)
...
- [Backup](https://documentation.commvault.com/v11/software/backups_for_kubernetes.html)
- [Restores](https://documentation.commvault.com/v11/software/restores_for_kubernetes.html)
