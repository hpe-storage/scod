...
The HPE Alletra 9000, Primera and 3PAR Container Storage Provider requires the following TCP ports to be open inbound between the array and the Kubernetes cluster worker nodes running the HPE CSI Driver for Kubernetes.
